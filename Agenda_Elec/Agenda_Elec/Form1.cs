...
namespace Agenda_Elec
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            cbGenero.DropDownStyle = ComboBoxStyle.DropDownList; // Solo permite seleccionar

            cbEstado.Items.Clear();
            cbEstado.Items.Add("Soltero(a)");
            cbEstado.Items.Add("Casado(a)");
            cbEstado.Items.Add("Divorciado(a)");
            cbEstado.Items.Add("Viudo(a)");
            cbEstado.Items.Add("Unión libre");
            cbEstado.DropDownStyle = ComboBoxStyle.DropDownList; // Solo permite seleccionar
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            Persona.FechNacimiento = dtpFechaNacimiento.Value.ToString("yyyy-MM-dd");
            ...
            Persona.EstadoCivil = cbEstado.Text;
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            contacto.FechNacimiento = dtpFechaNacimiento.Value.ToString("yyyy-MM-dd");
            ...
            contacto.Genero = cbGenero.Text.Trim();
            contacto.EstadoCivil = cbEstado.Text.Trim();
        ...
        private void CargarContactoEnCampos(Contactos persona)
        {
            ...
            dtpFechaNacimiento.Value = DateTime.Parse(persona.FechNacimiento);
            ...
            cbGenero.Text = persona.Genero;
            cbEstado.Text = persona.EstadoCivil;
        }
        ...
        private void cbGenero_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Seleccionaste: " + generoSeleccionado);
        ...
        private void cbEstado_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Seleccionaste: " + estadoSeleccionado);
        }
}}
